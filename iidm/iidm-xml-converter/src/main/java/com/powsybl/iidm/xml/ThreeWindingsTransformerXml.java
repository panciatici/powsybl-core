...
class ThreeWindingsTransformerXml extends AbstractTransformerXml<ThreeWindingsTransformer, ThreeWindingsTransformerAdder> {
    ...
    protected ThreeWindingsTransformer readRootElementAttributes(ThreeWindingsTransformerAdder adder, NetworkXmlReaderContext context) {
        ...
        double g2 = IidmXmlUtil.readDoubleAttributeFromVersionToLatest(IidmXmlVersion.V_1_1, "g2", 0, context);
        double b2 = IidmXmlUtil.readDoubleAttributeFromVersionToLatest(IidmXmlVersion.V_1_1, "b2", 0, context);
        ...
        double g3 = IidmXmlUtil.readDoubleAttributeFromVersionToLatest(IidmXmlVersion.V_1_1, "g3", 0, context);
        double b3 = IidmXmlUtil.readDoubleAttributeFromVersionToLatest(IidmXmlVersion.V_1_1, "b3", 0, context);
        ...
        double ratedU0 = IidmXmlUtil.readDoubleAttributeFromVersionToLatest(IidmXmlVersion.V_1_1, "ratedU0", context);
